...
public class Id extends OSPABA.IdList
{
	...
	public static final int hlavnyAgent = 1;
	public static final int agentSestier = 9;
	public static final int agentOkolia = 3;
	public static final int agentLekarov = 10;
	public static final int agentUrgentu = 5;
	public static final int agentVstupnehoVysetrenia = 6;
	public static final int agentOsetrenia = 7;
	public static final int agentAmbulancii = 8;
	public static final int hlavnyManager = 101;
	public static final int managerSestier = 109;
	public static final int managerOkolia = 103;
	public static final int managerLekarov = 110;
	public static final int managerUrgentu = 105;
	...
	public static final int odchodPacienta = 1011;
